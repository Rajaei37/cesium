...
class LandingPageController extends Controller
{
    public function index()
    {
        $features = [
            [
                'icon' => '/assets/icons/paid_media.svg',
                'title' => 'Paid Media',
            ...
            [
                'icon' => '/assets/icons/seo_optimization.svg',
            ...
            [
                'icon' => '/assets/icons/data_analytics.svg',
            ...
            [
                'icon' => '/assets/icons/content_marketing.svg',
            ...
            [
                'icon' => '/assets/icons/email_marketing.svg',
            ...
            [
                'icon' => '/assets/icons/branding_visual_identity.svg',
            ...
            [
                'icon' => '/assets/icons/influencer_marketing.svg',
