    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between w-full">
      ...
      <div class="hidden md:flex items-center space-x-4">
        ...
        <div class="flex items-center space-x-3 ml-4">
          ...
          <a href="https://dribbble.com/cesiumagency" target="_blank" class="text-white hover:text-secondary transition-colors duration-300 flex items-center justify-center">
