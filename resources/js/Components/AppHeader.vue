  ...
  <nav :class="[
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between w-full">
      ...
      <div class="hidden md:flex items-center space-x-4">
        <Link 
          href="/join-our-team" 
          class="bg-[#FFD700] text-[#4A248C] font-bold px-6 py-2 shadow-lg hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105"
        >
          Join our Team
        </Link>
        <Link href="/contact-us" class="bg-[#FFD700] text-[#4A248C] font-bold px-6 py-2 shadow-lg hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105">
          contact us
        </Link>
      </div>

      <!-- Social Media Icons (Desktop) -->
      <div class="hidden md:flex items-center space-x-3 ml-4 absolute top-4 right-4">
        ...
        <a href="https://www.dribbble.com/cesiumagency" target="_blank" class="text-white hover:text-secondary transition-colors duration-300 flex items-center justify-center">
          <img src="/assets/social-icons/dribbble.svg" alt="Dribbble" class="h-5 w-5 object-contain transition-all duration-300">
        </a>
    ...
    <div v-if="mobileMenuOpen" class="fixed top-20 left-0 right-0 bottom-0 bg-primary text-white shadow-lg animate-slide-down z-[9999] md:hidden overflow-y-auto">
      <div class="px-4 py-6 space-y-6 w-full">
        ...
        <Link href="/join-our-team" @click="closeMobileMenu" class="block bg-[#FFD700] text-[#4A248C] font-bold px-6 py-2 shadow-lg transition-all duration-300 flex items-center justify-center text-lg">
          Join our Team
        </Link>
        
        <!-- Mobile CTA -->
        <div class="pt-6 border-t border-gray-200">
          <Link href="/contact-us" @click="closeMobileMenu" class="w-full bg-[#FFD700] text-[#4A248C] font-bold px-6 py-3 shadow-lg transition-all duration-300 flex items-center justify-center text-lg">
            contact us
          </Link>
        </div>
