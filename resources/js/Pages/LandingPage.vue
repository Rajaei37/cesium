...
<section class="py-20 bg-[#362869] text-white relative overflow-hidden">
  ...
  <div class="container mx-auto px-6 text-center relative z-10">
    ...
    <div class="text-center mt-12">
      <a href="https://odin-recharge-bot.online/what-we-offer" class="inline-block bg-[#facb24] text-[#362869] font-bold py-4 px-8 shadow-lg hover:bg-yellow-300 transition duration-300 transform hover:scale-105" style="border-radius: 0.56px;">
